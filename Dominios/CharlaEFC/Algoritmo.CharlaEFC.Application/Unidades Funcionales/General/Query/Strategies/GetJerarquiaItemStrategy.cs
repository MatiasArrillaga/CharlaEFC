...
namespace Algoritmo.CharlaEFC.Application.General.Query
{
    ...
    /// </summary>
    public class GetJerarquiaItemStrategy : GetEntidadStrategy
    {
        public GetJerarquiaItemStrategy(IWorkContext workContext, GetEntidadStrategyParams execParams) : base(workContext, execParams)
        {
        }
            ...
            where TInAndReturnItem : class, IEntity
        {
            ...
            var query = repo.Entities
                            .Include(t => (t as JerarquiaItem).Jerarquia)
                            .Include(t => (t as JerarquiaItem).Padre)
                                .ThenInclude(p => p.Jerarquia)
                            .Select(t => t);
            ...
            where TInAndReturnItem : class, IEntity
        {
            ...
            var query = repo.Entities
                            .Include(t => (t as JerarquiaItem).Jerarquia)
                            .Include(t => (t as JerarquiaItem).Hijos)
                                .ThenInclude(p => p.Jerarquia)
                   .Select(t => t);
